...
class Simulator:
                ...
                while True:
                    try:
                        ...
                        if len(raw_msglen) < 4:
                            ...
                            raise ValueError(
                                "Incomplete length prefix received"
                            )
                        ...
                        try:
                            ...
                            logger.error("Cannot send data, broken pipe.")
                            break
    ...
    def execute_tx(
        self, payload, stamp_cost, environment: dict = {}, executor=None
    ):
